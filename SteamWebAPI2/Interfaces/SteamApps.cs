...
namespace SteamWebAPI2.Interfaces
{
    public class SteamApps : SteamWebInterface, ISteamApps
    {
        ...
        {
            var steamAppList = await GetAsync<SteamAppListResultContainer>("GetAppList", 2);
        ...
        public async Task<SteamAppUpToDateCheckModel> UpToDateCheckAsync(int appId, int version)
        {
            ...
            var upToDateCheckResult = await GetAsync<SteamAppUpToDateCheckResultContainer>("UpToDateCheck", 1, parameters);
